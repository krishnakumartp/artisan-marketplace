...
const Filters = () => {
    ...
    const filterSearch = (id, value) => {
        if (id === "category-container") {
            setCategoryList(allCategory.filter(elm => elm.value.toLowerCase()?.startsWith(value.toLowerCase())).slice(0, 8));
        }
        else if (id === "brand-container") {
            setBrandList(allBrand.filter(elm => elm.value.toLowerCase()?.startsWith(value.toLowerCase())).slice(0, 8));
        }
        else if (id === "color-container") {
            setColorList(allColor.filter(elm => elm.value.toLowerCase()?.startsWith(value.toLowerCase())).slice(0, 8));
        }
    };
            ...
            <section>
                <div className="box-border transition-margin duration-200 ease-[cubic-bezier(0.25,0.46,0.45,0.94)] mt-0 pt-[23px]">
                    <div className="relative border-r-0 pt-0px pb-[15px] pl-[25px] border-b-[1px] border-b-[#e9e9ed]">
                        ...
                        <span className="absolute top-0.5 right-2.5 font-bold uppercase text-[#ff3f6c] text-[13px] cursor-pointer">clear all</span>
                    </div>
                    ...
                    <div className="relative pt-[20px] pb-[15px] pl-[25px] border-b-[1px] border-b-[#e9e9ed] border-r-[1px] border-r-[#edebef]">
                        ...
                        <div className="absolute top-[12px] right-[14px] w-[30px] h-[30px] bg-[#f5f5f6] rounded-full" id="category-container" onClick={() => showSearch('category-container')}>
                            ...
                            <span className="inline-block absolute cursor-pointer right-1 top-1 scale-75 w-[21px] h-[21px] bg-[url('/images/icons.png')] bg-[-754px_0] bg-[length:1404px_105px]" onClick={(e) => closeSerch(e, "category-container")}></span>
                        </div>
                            ...
                            {categoryList?.map(category => (
                                <li className="text-sm mb-[7px]" key={category.label}>
                                    <label className="block w-[95%] whitespace-nowrap cursor-pointer overflow-hidden text-ellipsis min-h-[17px] text-[#282c3f] relative">
                                        <input className="peer my-0 ms-0 me-4 invisible box-border p-0" type="checkbox" />
                                        {category.label}
                    ...
                    <div className="relative pt-[20px] pb-[15px] pl-[25px] border-b-[1px] border-b-[#e9e9ed] border-r-[1px] border-r-[#edebef]">
                        ...
                        <div className="absolute top-[12px] right-[14px] w-[30px] h-[30px] bg-[#f5f5f6] rounded-full" id="brand-container" onClick={() => showSearch("brand-container")}>
                            ...
                            <span className="inline-block absolute cursor-pointer right-1 top-1 scale-75 w-[21px] h-[21px] bg-[url('/images/icons.png')] bg-[-754px_0] bg-[length:1404px_105px]" onClick={(e) => closeSerch(e, "brand-container")}></span>
                        </div>
                    ...
                    <div className="relative pt-[20px] pb-[15px] pl-[25px] border-b-[1px] border-b-[#e9e9ed] border-r-[1px] border-r-[#edebef]">
                        ...
                        <div className="absolute top-[12px] right-[14px] w-[30px] h-[30px] bg-[#f5f5f6] rounded-full" id="color-container" onClick={() => showSearch("color-container")}>
                            ...
                            <span className="inline-block absolute cursor-pointer right-1 top-1 scale-75 w-[21px] h-[21px] bg-[url('/images/icons.png')] bg-[-754px_0] bg-[length:1404px_105px]" onClick={(e) => closeSerch(e, "color-container")}></span>
                        </div>
                        ...
                        <ul className="m-0 pl-0">
                            {colorList?.map(color => (
                                <li className="text-sm mb-[7px]" key={color.label}>
                                    <label className="block w-[95%] whitespace-nowrap cursor-pointer overflow-hidden text-ellipsis min-h-[17px] text-[#282c3f] relative">
                                        <input className="peer my-0 ms-0 me-4 invisible box-border p-0" type="checkbox" />
                                        <div className={`w-[15px] h-[15px] rounded-full inline-block mr-2 ml-0 cursor-pointer relative leading-[16px] align-top ${color.label === "Multi" ? "bg-[url('/images/icons.png')] bg-[length:1404px_105px] bg-[-2494px_-60px]" : color.label?.toLowerCase()}`}></div>
                        ...
                        <ul className="m-0 pl-0">
                            {discountList?.map(discount => (
                                <li className="text-sm mb-[7px]" key={discount.label}>
                                    <label className="block w-[95%] whitespace-nowrap cursor-pointer overflow-hidden text-ellipsis min-h-[17px] text-[#282c3f] relative">
                                        <input className="peer my-0 ms-0 me-4 invisible box-border p-0" name="discount_product" type="radio" value={discount.value} />
                                        {discount.label}
