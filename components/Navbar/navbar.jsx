        ...
        <header className="fixed top-0 left-0 right-0 z-10 bg-white shadow-[#0000000D_0px_4px_12px_0px] hidden lg:block">
            <div className="m-auto min-w-[980px] leading-[80px]">
                ...
                <div className="float-left ml-[2%] xl:ml-[4%]">
                    <a href="/">
                    <Image src={Logo} className="inline-block align-middle p-0 m-0 w-[53px] h-[36px] bg-[-462px_0px] bg-[url('/images/logo-1.avif')] bg-[length:1404px_105px]"/>
                ...
                <div className="float-right flex leading-[0px] h-10 mt-5 me-[30px] mb-0 ms-[10px]">
                    ...
                    <Link href="/" className="my-0 ms-[10px] me-[55px] flex relative text-[#282c3f] bg-transparent">
                    ...
                    <Link href="/" className="my-0 ms-[15px] me-[55px] flex relative text-[#282c3f] bg-transparent">
